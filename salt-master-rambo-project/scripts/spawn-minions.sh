...
su saltmaster -c "cd /home/saltmaster;\
  ...
  python /home/saltmaster/salt_src/scripts/salt-cloud -c /home/saltmaster/salt_controlplane/etc/salt -P -y -m /home/saltmaster/salt_controlplane/etc/salt/cloud.map"
